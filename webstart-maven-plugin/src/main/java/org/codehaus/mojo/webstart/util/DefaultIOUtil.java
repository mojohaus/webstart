...
public class DefaultIOUtil extends AbstractLogEnabled implements IOUtil {
    ...
    public boolean copyFileToDirectoryIfNecessary(File sourceFile, File targetDirectory) throws MojoExecutionException {
        ...
        if (shouldCopy) {
            ...
            getLogger()
                    .debug("Source file hasn't changed. Do not overwrite " + targetFile + " with " + sourceFile + ".");
        }
     ...
     * {@inheritDoc}
     */
    public void createArchive(File directory, File archive) throws MojoExecutionException {
    ...
    private void copyDirectoryStructure(
            File sourceDirectory, File destinationDirectory, String includes, String excludes)
