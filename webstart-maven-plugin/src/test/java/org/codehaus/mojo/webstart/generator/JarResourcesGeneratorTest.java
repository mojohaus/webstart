...
public class JarResourcesGeneratorTest extends TestCase {
    ...
    public void testGetDependenciesText() throws Exception {
        ...
        GeneratorTechnicalConfig generatorTechnicalConfig = new GeneratorTechnicalConfig(
                ...
                "utf-8");
        JarResourceGeneratorConfig jarResourceGeneratorConfig =
                new JarResourceGeneratorConfig(jarResources, null, null, null, null);
        ...
        //                                       "default-jnlp-template.vm", outputFile, templateFile.getName(),
        // jarResources,
        ...
        String expectedText = EOL + "<jar href=\"href1\" version=\"1.1\" main=\"true\"/>" + EOL
                + "<jar href=\"href2\" version=\"1.2\"/>" + EOL
                + "<jar href=\"href3\"/>" + EOL;
        ...
        JarResourceGeneratorConfig jarResourceGeneratorConfig2 =
                new JarResourceGeneratorConfig(jarResources, "myLib", null, null, null);
        ...
        //                                       "default-jnlp-template.vm", outputFile, templateFile.getName(),
        // jarResources,
        //                                       mainClass, "jar:file:/tmp/path/to/webstart-plugin.jar", "myLib",
        // "utf-8" );

        String expectedText2 = EOL + "<jar href=\"myLib/href1\" version=\"1.1\" main=\"true\"/>" + EOL
                + "<jar href=\"myLib/href2\" version=\"1.2\"/>" + EOL
                + "<jar href=\"myLib/href3\"/>" + EOL;
    ...
    private ResolvedJarResource buildJarResource(
