...
String[] expectedContains = ["<jar href=\"lib/share-1.0-SNAPSHOT.jar\"/>", "<jar href=\"lib/share1-1.0-SNAPSHOT.jar\"/>", "<jar href=\"lib/client-1.0-SNAPSHOT.jar\" main=\"true\"/>"]
...
expectedContains = ["<jar href=\"lib/share.jar\" version=\"1.0-SNAPSHOT\"/>", "<jar href=\"lib/share1.jar\" version=\"1.0-SNAPSHOT\"/>", "<jar href=\"lib/client-1.0-SNAPSHOT.jar\" main=\"true\"/>"]
expectedContains.each {
    assert assertContains(content, it)
}
...
expectedContains = ["<jar href=\"lib/share.jar\" version=\"1.0-SNAPSHOT\"/>", "<jar href=\"lib/client1-1.0-SNAPSHOT.jar\"/>", "<jar href=\"lib/share1.jar\" version=\"1.0-SNAPSHOT\"/>", "<jar href=\"lib/client-1.0-SNAPSHOT.jar\" main=\"true\"/>"]
expectedContains.each {
    assert assertContains(content, it)
}
...
expectedContains = [ "<file>client-1.0-SNAPSHOT.jar</file>", "<file>share-1.0-SNAPSHOT.jar</file>", "<file>share1-1.0-SNAPSHOT.jar</file>", "<file>client1-1.0-SNAPSHOT.jar</file>" ]
expectedContains.each{
  assert assertContains( content,  it )
}
